...
(paste ("Optimal Cut off :", optCutOff))

(paste("MisClassification Error : ",  misClassError(predicted.data$actuals,
                                                          predicted.data$probability.of.Attrition, 
                                                          threshold = optCutOff )))

(paste("sensitivity: ",  sensitivity(predicted.data$actuals,
                                           predicted.data$probability.of.Attrition, 
                                           threshold = optCutOff )))

(paste("specificity : ", specificity( predicted.data$actuals,
                                            predicted.data$probability.of.Attrition,
                                            threshold = optCutOff ) ))
```
